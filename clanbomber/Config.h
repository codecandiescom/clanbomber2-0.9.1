 ...
 *                                                                         *
 ***************************************************************************/
// $Id: Config.h,v 1.6 2003/06/12 00:39:46 xmassx Exp $
...
public:
	...
	static void set_filename(CL_String _filename);
	static void set_path(CL_String _path);
    ...
    static void set_last_server(CL_String server_name);
    static CL_String get_last_server();
...
protected:
	...
	static CL_String filename;
	static CL_String path;

    static CL_String last_server;
};
